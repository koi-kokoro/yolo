...
class SemanticRuntime:
    ...
    def model_info(self) -> dict:
        ...
        return {"ready": True, "engine": self.engine.engine, "provider": self.engine.provider, "model_name": self.engine.metadata["model"], "model_version": "baseline-e50-i512-b2", "input_size": self.engine.metadata["input"]["size"], "classes": self.engine.metadata["classes"]}
