...
class Settings(BaseSettings):
    ...
    # —— 应用基础配置 ————————————————————————————————
    APP_NAME: str = "lee Agent Platform"
    ...
    DB_PORT: int = 5432
    DB_NAME: str = "lee_agent"
    DB_USER: str = "lee_admin"
    DB_PASSWORD: str = "lee_admin"
    ...
    def parse_debug(cls, value):
        """Accept common build-mode strings from the host environment."""
